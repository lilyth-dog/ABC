...
항목 & 통과 & 전체 & 비고 \\
\midrule
백엔드 pytest & 42 & 42 & coverage 62.06\% \\
...
\begin{itemize}
  ...
  \item 성능은 1000 이벤트 p95 7.820ms, 5000 이벤트 p95 145.286ms로, 일반적인 수백~천 단위 세션에는 충분해 보인다.
