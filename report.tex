...
항목 & 통과 & 전체 & 비고 \\
\midrule
백엔드 pytest & 33 & 33 & coverage 57.24\% \\
...
\begin{itemize}
  ...
  \item 성능은 1000 이벤트 p95 7.765ms, 5000 이벤트 p95 144.462ms로, 일반적인 수백~천 단위 세션에는 충분해 보인다.
...
(3) 계획 시간 지표의 평가/구현 정의 충돌은 해소됐지만, 실제 사용자 행동 라벨에 대한 타당도 검증은 아직 필요하다.
